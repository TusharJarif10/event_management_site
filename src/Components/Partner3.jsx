    ...
    return (
        ...
        <div className="2xl:mx-auto 2xl:container  lg:px-20 md:px-6 mx-10 ">
                ...
                <div className="flex flex-col justify-center items-center text-center space-y-4">
                     ...
                     <p className="text-base  text-center text-gray-600 w-full md:w-10/12"> It has been the most incredible journey. We work with some of the best institution and company across the nation</p>
                 </div>
