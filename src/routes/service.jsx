                ...
                <div className='flex flex-col justify-between items-center gap-10'>
                    ...
                    <div
                        ...
                        <div className='flex flex-row gap-10 justify-center items-center px-5'>
                            ...
                            <div className='lg:w-2/4 xl:w-2/4 w-full' data-aos="fade-left" data-aos-duration="900">
                                <img className='object-cover h-[350px] w-[650px]' src={social} alt="" />
                            </div>
                        </div>
                    </div>
      ...
      lg:px-20 xl:px-20 max-w-screen-xl  ">
        ...
        <>
            ...
            lg:px-12 xl:px-36 mt-10 mb-10 pt-20'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='lg:w-1/3 w-full' >
                                <img className='object-cover h-[210px] w-[550px]' src={corporate} alt="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='lg:w-1/3 w-full'>
                                <img className='object-cover h-[210px] w-[550px]'  src={entertainment} alt="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='lg:w-1/3 w-full'>
                                <img className='object-cover h-[210px] w-[550px]'  src={social} alt="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='lg:w-1/3 w-full'>
                                <img className='object-cover h-[210px] w-[550px]'  src={marketing} alt="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='w-auto'>
                                <img className='object-cover h-[210px] w-[550px]'  src={trade} alt="" />
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='lg:w-1/3 w-full'>
                                <img className='object-cover h-[210px] w-[550px]'  src={videography} alt="" />
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='lg:w-1/3 w-full'>
                                <img className='object-cover h-[210px] w-[550px]'  src={concert} alt="" />
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div className='flex lg:flex-row flex-col gap-5 justify-between'>
                            ...
                            <div className='lg:w-1/3 w-full'>
                                <img className='object-cover h-[210px] w-[550px]'  src={postevent} alt="" />
                            </div>
                        </div>
                ...
                <div className=" mt-5 pt-10 mb-5 flex flex-col items-center justify-center flex-wrap text-wrap gap-6 lg:px-20 xl:px-20 md:mx-auto mx-4 ">
                    <h2 >
