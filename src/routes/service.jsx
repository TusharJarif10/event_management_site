...
const Service = () => {
    ...
    return isDesktop ? (
        ...
        <>
            ...
            <div
                className="relative flex flex-col justify-between lg:flex-row px-4 mx-2 sm:px-8 px-10 lg:px-12 xl:px-36 mt-20 mb-20 pb-10 lg:pt-10 xl:pt-10" id="entertainment" data-aos="fade-left" data-aos-duration="900">
            ...
            <div
                className="relative flex flex-col justify-between lg:flex-row px-4 mx-2 sm:px-8 px-10 lg:px-12 xl:px-36 mt-20 mb-20 pb-10 lg:pt-10 xl:pt-10" id='socialevent' data-aos="fade-left" data-aos-duration="900">
            ...
            <div
                className="relative flex flex-col justify-between lg:flex-row px-4 mx-2 sm:px-8 px-10 lg:px-12 xl:px-36 mt-20 mb-20 pb-10 lg:pt-10 xl:pt-10" id='marketing' data-aos="fade-left" data-aos-duration="900">
            ...
            <div
                className="relative flex flex-col justify-between lg:flex-row px-4 mx-2 sm:px-8 px-10 lg:px-12 xl:px-36 mt-20 mb-20 pb-10 lg:pt-10 xl:pt-10" id='postevent' data-aos="fade-left" data-aos-duration="900">
            ...
            <div
                className="relative flex flex-col justify-between lg:flex-row px-4 mx-2 sm:px-8 px-10 lg:px-12 xl:px-36 mt-20 mb-20 pb-10 lg:pt-10 xl:pt-10" id='photovideo' data-aos="fade-left" data-aos-duration="900">
